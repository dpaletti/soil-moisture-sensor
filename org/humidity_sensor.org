...
** PCB development
*** Block diagram
#+begin_src mermaid :file ./diagrams/block_diagram.png :mermaid-config-file "./diagrams/mermaid_config.json"
graph TD
...
#+end_src
#+RESULTS:
[[file:./diagrams/block_diagram.png]]

*** Soil moisture/permittivity sensor
...
*Open-Next* the most up to date resource on open source hardware business models: https://opennext.eu/

Doctoral thesis on *open source hardware business models*:
https://theses.hal.science/tel-02504769v1

*Remodel* a toolkit for business model development:
    - remodel (business model toolkit for ohw):
    https://web.archive.org/web/20250130031505/https://www.remodel.dk/

    - Corso REMODEL: https://medium.com/@villum/the-remodel-toolkit-is-now-online-e7deb155743
